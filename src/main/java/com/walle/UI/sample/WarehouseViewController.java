...
import com.walle.UI.model.WarehouseTable;
...
public class WarehouseViewController implements Initializable  {
    ...
    private com.walle.controllers.WarehouseController warehouseController;
    ...
    private ObservableList <WarehouseTable> insertData() {
        ...
        for (int i = 0; i < warehouse.size ( ); i++) {
            ...
            data.add (new WarehouseTable (warehouse.get (i).getId ( ), warehouse.get (i).getName ( ), warehouse.get (i).getCountry ( ), warehouse.get (i).getAddress( ),warehouse.get (i).getPhone( )));
        }
        return data;
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        iPhone.setCellValueFactory (new PropertyValueFactory <> ("rPhone"));
         ...
         warehouseController= new com.walle.controllers.WarehouseController ();
        try {
            warehouse = warehouseController.displayWarehouse ( );
        } catch (Exception e) {
